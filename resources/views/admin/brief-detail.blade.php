        ...
        <div class="detail-card">
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    ...
                    @if($brief->budget)
                    <div class="detail-item">
                        <span class="detail-label">Budget (Rp)</span>
                        <span class="detail-value">{{ number_format($brief->budget, 0, ',', '.') }}</span>
                    </div>
                    @endif
                    @if($brief->timeline)
                    <div class="detail-item">
                ...
                @if($payment)
                    <div class="payment-info">
                        <div class="detail-grid">
                            ...
                            <div class="detail-item">
                                <span class="detail-label">Jumlah Pembayaran (Rp)</span>
                                <span class="detail-value">{{ number_format($payment->amount ?? 0, 0, ',', '.') }}</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">Status</span>
                                <span class="detail-value">
