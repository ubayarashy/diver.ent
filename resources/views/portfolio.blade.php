    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-about">
                <h4>diver.ent</h4>
                <p>Digital marketing agency terpercaya di Medan. Kami membantu bisnis tumbuh melalui strategi digital yang terukur dan kreatif.</p>
            ...
            <div>
                ...
                <p style="margin-top:8px;">📍 Medan, Sumatera Utara</p>
            </div>
        </div>
